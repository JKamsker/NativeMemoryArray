...
namespace Cysharp.Collections.Pooling;


public readonly struct NativeMemoryReference
{
    public readonly IntPtr DataPointer;
    public readonly long Length;

    public NativeMemoryReference(IntPtr dataPointer, long length)
    {
...
// No support for 2.0 yet.
// We can copy https://github.com/dotnet/maintenance-packages/tree/c97f1fe642a30e2034f33c410e6e92af8d6a1e75/src/System.Buffers/src/System/Buffers if we need to in the future
...
internal sealed partial class TlsOverPerCoreLockedStacksArrayPool<T>
{
    ...
    public T[] Rent(int minimumLength)
    {
        ...
        buffer = new T[minimumLength]; //GC.AllocateUninitializedArray<T>(minimumLength);
...
private sealed class LockedStack
    ...
    internal static class Utilities
    {
        ...
        /// Copy from BitOperations.Log2SoftwareFallback
        /// </summary>
